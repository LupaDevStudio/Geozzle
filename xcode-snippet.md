...
#include "Python.h"
#include "/Users/lisecreusy/Documents/Paul/dist/include/common/sdl2/SDL_main.h"
#include <dlfcn.h>

// Beginning of Reward interstitial block
...
- (void)createAndLoadInterstitial {
    ...
    self.interstitial = [[GADInterstitial alloc] initWithAdUnitID:@"ca-app-pub-2909842258525517/5707850535"]; // true id for intersitial
...
// End of Reward interstitial block
...
#define MAIN_EXT @"pyc"
    ...
    exit(ret);
    // Reward interstitial changes
    [FIRApp configure];
    [GADMobileAds configureWithApplicationID:@"ca-app-pub-2909842258525517~3825635685"];
    // End Reward interstitial changes
    return ret;
}
