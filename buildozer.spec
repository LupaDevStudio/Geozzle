...
source.include_exts = py,png,jpg,kv,atlas,json,txt,ttf,wav,ico,ogg,otf,mp3,gif
...
requirements = python3, kivy, android, androidstorage4kivy, Pillow
...
android.extra_manifest_xml = ./resources/manifest/extra_manifest.xml
